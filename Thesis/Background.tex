...
\dot{d} = H_0 r.
\end{equation}
This effect was first described by \citet{hubble_1929}, and explains why distant galaxies appear to be moving away from us. More generally, we call this term in the proper velocitiy the \textit{Hubble flow}.
...
1 + z = \frac{1}{a}
\end{equation}
in analogy to this phenomenon. This is a descending unit of time that is often used interchangably with the scale factor, $a$.
...
K_t(\Delta t) : \begin{cases} 
      ...
      \end{cases}
\end{eqnarray}
Since these operators derive directly from a separatable Hamiltonian, this integrator is symplectic. Even though the energy of our cosmological system is not conserved, there will be no drift about the continuum system's actual energy. This is the integration scheme used in \textsc{Gadget-3} for cosmological simulations.
